...
import csv
with open('/Users/sanabahari/Desktop/Insight-Proj/products.csv') as prod_test:
...
with open('/Users/sanabahari/Desktop/Insight-Proj/order_products.csv') as order_test:
...
with open('/Users/sanabahari/Desktop/Insight-Proj/instacart_2017_05_01/reports22.csv', 'w') as f:
    writer = csv.writer(f)
